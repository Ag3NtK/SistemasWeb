...
function saludo(req, res) {
    ...
    if (num === 42) {
        saludo = `<p>En realidad, esa es la pregunta final sobre <b>la vida, el universo y todo lo demás.</b></p>`;
    } else {
        for (let i = 0; i < num; i++) {
...
<html>
    ...
    <body>
    <h1>Me has pedido que te salude ${num} veces.</h1>
    <p>Pulsa en <a href="index.html">inicio</a> para volver al ejercicio.</p>
    ${saludo}
    </body>
</html>`);
};